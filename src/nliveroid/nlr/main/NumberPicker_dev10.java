...
/**
 *
 * このクラスを基底に使ってキーイベントを書き換えた
 * A view for selecting a number
 *
 * For a dialog using this view, see {@link android.app.TimePickerDialog}.
 * @hide
 */
public class NumberPicker_dev10 extends LinearLayout implements NumberPickable{
    ...
    public interface OnChangedListener {
         ...
         */
        void onChanged(NumberPicker_dev10 picker, int oldVal, int newVal);
    }
     ...
     */
    public static final NumberPicker_dev10.Formatter TWO_DIGIT_FORMATTER =
            new NumberPicker_dev10.Formatter() {
     ...
     */
    public NumberPicker_dev10(Context context) {
        this(context, null);
    }
     ...
     */
    public NumberPicker_dev10(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mText.setKeyListener(new KeyListener(){
			@Override
			...
			public boolean onKeyDown(View arg0, Editable arg1, int arg2,
					KeyEvent arg3) {
				SpannableStringBuilder builder = (SpannableStringBuilder) mText.getText();
				int start = mText.getSelectionStart();
				int end = mText.getSelectionEnd();
				int keycode = arg3.getKeyCode();
				if(start>end){
					int temp = end;
					end = start;
					start = temp;
				...
				if(builder.length() <= 1&&keycode==KeyEvent.KEYCODE_DEL)return false;//1以上の長さがなければ何もしない(エディタは空にしない)
				if(builder.length() >= 2&&!(keycode==KeyEvent.KEYCODE_DEL))return false;//2桁以上なら数値は入れれない
				if(end - start > 0){//選択されていたらどんなキーが来ても消しちゃう
					mText.setText(builder.replace(start, end, ""));
				}
				if(keycode == KeyEvent.KEYCODE_DEL){
					if(builder.length()>0&&start>0){
					mText.setText(builder.replace(start-1, start, ""));
					mText.setSelection(start-1);
					}
				}
				switch(keycode){
				case KeyEvent.KEYCODE_0:
					mText.setText(builder.insert(start,  "0"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_1:
					mText.setText(builder.insert(start,  "1"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_2:
					mText.setText(builder.insert(start,  "2"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_3:
					mText.setText(builder.insert(start,  "3"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_4:
					mText.setText(builder.insert(start,  "4"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_5:
					mText.setText(builder.insert(start,  "5"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_6:
					mText.setText(builder.insert(start,  "6"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_7:
					mText.setText(builder.insert(start,  "7"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_8:
					mText.setText(builder.insert(start,  "8"));
					mText.setSelection(start+1);
					break;
				case KeyEvent.KEYCODE_9:
					mText.setText(builder.insert(start,  "9"));
					mText.setSelection(start+1);
					break;
				}
				mCurrent = Integer.parseInt(((SpannableStringBuilder) mText.getText()).toString());
				return false;
			}
			@Override
