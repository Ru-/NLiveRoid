...
public interface ChannelBuffer extends Comparable<ChannelBuffer> {
     ...
     */
    int writableBytes();
    //boolean readable();無くした
    //boolean writable();無くした
    ...
    //short getUnsignedByte(int index);無くした
    ...
    //int getUnsignedShort(int index);無くした
    ...
    //void  getBytes(int index, ChannelBuffer dst);無くした

    // void  getBytes(int index, ChannelBuffer dst, int length);無くした

    // void  getBytes(int index, byte[] dst);無くした
    /**
     ...
     *            {@code this.capacity}
     */
   // void setBytes(int index, ChannelBuffer src);無くした
     ...
     */
    //void setBytes(int index, ChannelBuffer src, int length);無くした
     ...
     *            {@code this.capacity}
     */
    //void setBytes(int index, byte[] src);無くした
    ...
    //void readBytes(ChannelBuffer dst);無くした
    ...
    //void writeChar(int value);無くした
    //void writeFloat(float value);無くした
    //void writeDouble(double value);無くした
    //void writeBytes(ChannelBuffer src);無くした
