...
public abstract class HeapChannelBuffer extends AbstractChannelBuffer {
    ...
    public byte getByte(int index) {//indexが0なら先頭要素の1バイトが返ってくる(02なら2みたいな)
        return array[index];
    }
    ...
    public ChannelBuffer slice(int index, int length) {
        if (index == 0) {
            ...
            if (length == array.length) {
                ChannelBuffer slice = new BigEndianHeapChannelBuffer(array, readerIndex(), writerIndex());
