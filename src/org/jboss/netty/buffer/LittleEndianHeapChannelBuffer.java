...
public class LittleEndianHeapChannelBuffer extends HeapChannelBuffer {
     ...
     *
     */
    public LittleEndianHeapChannelBuffer(byte[] array, int readerIndex, int writerIndex) {
    ...
    public ChannelBuffer copy(int index, int length) {
        ...
        return new LittleEndianHeapChannelBuffer(copiedArray,0,copiedArray.length);
    }
