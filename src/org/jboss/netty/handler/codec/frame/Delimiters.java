...
public class Delimiters {
    ...
    public static ChannelBuffer[] nulDelimiter() {
        return new ChannelBuffer[] {
                ChannelBuffers.wrappedBuffer(ChannelBuffers.BIG_ENDIAN,new byte[] { 0 }) };
    }
    ...
    public static ChannelBuffer[] lineDelimiter() {
        return new ChannelBuffer[] {
                ChannelBuffers.wrappedBuffer(ChannelBuffers.BIG_ENDIAN,new byte[] { '\r', '\n' }),
                ChannelBuffers.wrappedBuffer(ChannelBuffers.BIG_ENDIAN,new byte[] { '\n' }),
        };
    }
