...
import com.flazr.rtmp.client.Amf0Value.MetaDataValuesType;
 ...
 */
public class ValueToEnum<T extends TypeEnum> {


    private final TypeEnum[] lookupArray;
    private final int maxIndex;

    public ValueToEnum(final TypeEnum[] enumValues) {
        ...
        lookupArray = new TypeEnum[maxIndex + 1]; // use 1 based index
        for (final TypeEnum t : enumValues) {
    ...
    private String getErrorLogMessage(final int i) {
        return "bad value / byte: " + i + " (hex: " + String.valueOf(Utils.toHexChars((byte)i)) + ")";
    }
